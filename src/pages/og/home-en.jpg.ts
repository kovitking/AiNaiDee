            ...
            children: [
                  ...
                  children: [
                    {
                      type: 'div',
                      props: {
                        style: { fontSize: 64, fontWeight: 700, color: '#ededef', lineHeight: 1.15 },
                        children: 'Which AI can your',
                      },
                    },
                    {
                      type: 'div',
                      props: {
                        style: { fontSize: 64, fontWeight: 700, color: '#22c55e', lineHeight: 1.15 },
                        children: 'machine run?',
                      },
                    },
                  ],
                },
              ...
              },
              {
                ...
                props: {
                  ...
                  children: 'ainaidee.com — GPU, CPU, and RAM analysis in your browser',
                },
              },
            ],
          },
