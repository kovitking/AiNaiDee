...
`172.16.57.192:8587` ไม่มี Caddy ยังไม่มีอะไรในไดอะแกรมนี้ถูกสร้างเลยสักส่วน — เส้นประ + ป้าย
"PLANNED" ทั้งหมด
...
flowchart TB
    ...
    subgraph host["Ubuntu host — 172.16.57.192<br/>เครื่องเดิมที่มี ainaidee-app-1 รันอยู่แล้ว"]
        direction TB
